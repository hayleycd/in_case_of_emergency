...
SAMPLE_INFORMATION = {
    ...
    'shameless': [
        ...
        ('Contact her @hayleydenb on Twitter, or find here at https://CodeAndTea.com or https://www.linkedin.com/in/hayleydenbraverpe),
    ],
}
...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    security_check(send_to, send_from, incoming_message)
...
def security_check(req, send_to, send_from, incoming_message):
    is_sample = is_sample(req)
...
def send_follow_up_text(req, send_to, send_from, body, emergency_info):
